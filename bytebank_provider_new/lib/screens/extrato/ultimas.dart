...
import 'package:bytebank_provider_new/screens/extrato/lista.dart';
          ...
          builder: (context, transferencias, child) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, indice) {
                ...
                final _valor = _transferencia.valor.toString();
                final _conta = _transferencia.numeroConta.toString();
